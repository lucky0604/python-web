<template>
  <div class="monthKpi-container">
    <span class="monthKpi-container-title">{{month}} month</span>
    <BarPercent class="monthKpi-container-chart" :dataNum="articlesComplete"></BarPercent>
    <span class="monthKpi-container-text">Done articles percent</span>
    <span class="monthKpi-container-count">{{articlesComplete}}<b>articles</b></span>
  </div>
</template>
