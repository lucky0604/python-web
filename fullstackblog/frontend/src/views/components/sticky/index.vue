    ...
    <Sticky className="sub-navbar">
      ...
      <el-dropdown trigger="click">
        ...
        <el-dropdown-menu class="no-padding no-border" style="width: 300px" slot="dropdown">
          <el-input placeholder="Please enter something" v-model="url">
            <template slot="prepend">Enter url</template>
          </el-input>
        </el-dropdown-menu>
      </el-dropdown>

      <div class="time-container">
        <el-date-picker v-model="time" type="datetime" :picker-options="pickerOptions" format="yyyy-MM-dd HH:mm:ss" placeholder="Publish time"></el-date-picker>
      </div>
