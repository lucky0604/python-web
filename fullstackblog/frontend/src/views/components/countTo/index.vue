<template>
  <div class="components-container">
    ...
    <div style="margin-left: 25%; margin-top: 40px;">
      <label class="label" for="startValInput">Start value: <input type="number" v-model.number="setStartVal" name="startValInput" /></label>
      <label class="label" for="endValInput">End value: <input type="number" v-model.number="setEndVal" name="endValInput" /></label>
    ...
    _decimals() {
      if (this.setDecimals) {
        if (this.setDecimals < 0 || this.setDecimals > 20) {
          alert('digits argument must between 0 and 20')
          return 0
        }
